...
const Property = (props) => {
  const {user, offer, nearOffers, onBookmarksClick} = props;
  if (!offer) {
    return <Loading />;
  }
      ...
      <div className="property__container container">
        <div className="property__wrapper">
          ...
          <div className="property__name-wrapper">
            ...
            <button className={`property__bookmark-button button ${offer.isFavorite && `property__bookmark-button--active`}`} type="button" onClick={() => {
...
const mapStateToProps = (state, ownProps) => Object.assign({}, ownProps, {
  ...
  nearOffers: getTreeNearPlaces(state, getOfferById(state, ownProps.match.params.id), 3),
});
